...
# ===========================================================================
HOST = "Bhagyaprasad92"   # shown as  Bhagyaprasad92@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech CSE @ Aditya College '27"),
    ("kv", "Prev", "Flutter Dev Intern @ Technical Hub"),
    ("kv", "Also", "Competitive Programmer, 600+ DSA"),
    ("kv", "Focus", "Flutter . Full Stack . SDE-1"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Mobile", "Flutter, Dart, TensorFlow Lite"),
    ("kv", "Backend", "Node.js, Spring Boot, Java"),
    ("kv", "Database", "MongoDB, MySQL, PostgreSQL"),
    ("kv", "DevOps", "Firebase, Docker, Jenkins CI/CD"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "SafePulse -- offline crash-detection app, Top 7/900+ hackathon"),
